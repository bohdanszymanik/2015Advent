...
Use Paket to get the dependencies and packages right, after paket's done its stuff use VS/Atom/VS Code to run the script. If you've not used paket.exe before it's a two step process.
